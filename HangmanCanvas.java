...
/** Resets the display so that only the scaffold appears */
	...
	private void drawScaffold() {
		...
		GOval head = new GOval (xHead, yRope, 2*HEAD_RADIUS, 2*HEAD_RADIUS);
		GLine body = new GLine (xCenter, yBodyTop, xCenter, yBodyBottom);
		GLine leftUpperArm = new GLine (xCenter, yUpperArm, xCenter - UPPER_ARM_LENGTH, yUpperArm);
		GLine leftLowerArm = new GLine (xCenter - UPPER_ARM_LENGTH, yUpperArm, xCenter - UPPER_ARM_LENGTH, yLowerArm);
		GLine rightUpperArm = new GLine (xCenter, yUpperArm, xCenter + UPPER_ARM_LENGTH, yUpperArm);
		GLine rightLowerArm = new GLine (xCenter + UPPER_ARM_LENGTH, yUpperArm, xCenter + UPPER_ARM_LENGTH, yLowerArm);
		GLine leftHip = new GLine (xCenter, yBodyBottom, xCenter - HIP_WIDTH, yBodyBottom);
